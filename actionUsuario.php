            ...
            if($_SERVER["REQUEST_METHOD"] == "POST"){
                ...
                if(!$erroPreenchimento && !$erroUpload){
                    ...
                    if(mysqli_query($conn, $inserirUsuario)){
                        ...
                        echo "<img src='$fotoUsuario' alt='$nomeUsuario' style='width:200px; border-radius:8px; margin-bottom:1rem;'><br>";
                        echo "<h3 style='color:#fff; margin-bottom:0.5rem;'>$nomeUsuario</h3>";
                        echo "<h3 style='color:#fff; margin-bottom:0.5rem;'>$diaNascimentoUsuario/$mesNascimentoUsuario/$anoNascimentoUsuario</h3>";
                        echo "<p style='color:#fff; margin-bottom:0.5rem;'>$cidadeUsuario</p>";
                        echo "<p style='color:#fff; margin-bottom:0.5rem;'>$emailUsuario</p>";
                        echo "<p style='color:#fff; margin-bottom:0.5rem;'>$telefoneUsuario</p>";
                        echo "</div>";

                        mysqli_close($conn); //Essa função encerra a conexão com o Banco de Dados
                    }
                    else{
                        echo "<div style='color:#e74c3c; font-weight:700; text-align:center;'>Erro ao cadastrar Usuario: ".mysqli_error($conn)."</div>";
                    }
                }
            }
            else{
